...
$totquery = "SELECT * FROM `NR` WHERE `Ck` = 1 ORDER BY `T` DESC ";
...
$g = 0;
$totquery2 = "SELECT * FROM `NR` WHERE `Ck` = 0 ORDER BY `T` DESC ";
...
<body>
        ...
        <h2 style="font-size:19;">န၀မတန်း</h2>
    ...
    <?php 
        $nroll = '';
        $nroll = mysqli_num_rows(mysqli_query($con,"SELECT * FROM GN"));
        $arraysize = $nroll;
        $q = "SELECT * FROM `NR` WHERE `Ck` = 1 ORDER BY `T` DESC ";
        ...
        $g = $g+1;
        $s = 0;
        $q2 = "SELECT * FROM `NR` WHERE `Ck` = 0 ORDER BY `T` DESC ";
